...
wget -P /target/linux/generic/hack-5.10/ https://raw.githubusercontent.com/xiaotan8/Openwrt-actions/master/user/lienol-x64/952-net-conntrack-events-support-multiple-registrant.patch
